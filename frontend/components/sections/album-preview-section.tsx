  ...
  return (
    <SectionShell id="album-preview" className="relative overflow-hidden pt-10 md:pt-16">
      ...
      <AnimatedHeading
        ...
        description="팀사랑꾼들은 10곡 이상의 정규 1집을 목표로 하고 있습니다. 2025년 겨울, 입대를 한 달 앞두고 음악을 시작했습니다. 음악을 전공한 사람이 아니다보니 아직 2곡 정도밖에 전체적인 코드 구성을 완성하지 못했고 이마저도 데모의 데모 수준입니다. 그럼에도 건반과 이어폰 마이크만으로 입대 전 한 달간 즐겁게 작업한 데모를 공유합니다. 앞으로 한 곡 한 곡 쌓여가는 팀사랑꾼들의 첫 앨범을 함께 응원해주세요!"
        singleLineTitle
