    ...
    <div className="grid gap-6 lg:grid-cols-[1.15fr_1fr]">
        ...
        <div className="grid gap-5 md:grid-cols-[220px_1fr] md:items-center">
          ...
          <div className="space-y-6">
            <div>
              ...
              <h3 className="mt-3 text-3xl font-semibold tracking-tight text-paper md:text-5xl">{activeTrack.title}</h3>
              <p className="mt-2 text-sm text-paper/58 md:text-base">{activeTrack.artist}</p>
            </div>
            <div className="space-y-3">
              <div className="h-1.5 overflow-hidden rounded-full bg-white/10">
                <div className="h-full rounded-full bg-paper transition-all" style={{ width: `${progress}%` }} />
              </div>
      ...
      <div className="editorial-frame rounded-[32px] p-4 md:p-6">
        <div className="mb-5 flex items-center justify-between border-b border-line pb-4">
          ...
          <span className="text-xs uppercase tracking-[0.25em] text-paper/35">{tracks.length} pieces</span>
        </div>
            ...
            return (
              ...
              >
                <div className="flex items-center gap-4">
                  <span className="text-xs uppercase tracking-[0.22em] text-paper/35">{String(index + 1).padStart(2, '0')}</span>
                  <div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <span className="text-xs uppercase tracking-[0.2em] text-paper/45">{formatDuration(track.durationSeconds)}</span>
                </div>
              </button>
            );
          })}
